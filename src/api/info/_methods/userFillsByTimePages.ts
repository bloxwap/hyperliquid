...
/** Request parameters for the {@linkcode userFillsByTimePages} function. */
export type UserFillsByTimePagesParameters = Omit<UserFillsByTimeParameters, "reversed"> & {
  /**
 ...
 *
 * for await (const page of userFillsByTimePages({ transport }, {
 *   user: "0x...",
 ...
 */
export function userFillsByTimePages(
  config: InfoConfig,
