...
const UserPortfolioMarginActionSchema = /* @__PURE__ */ (() => {
  return v.omit(v.object(UserPortfolioMarginRequest.entries.action.entries), [
    "signatureChainId",
    "hyperliquidChain",
    "nonce",
  ]);
 ...
 * import { userPortfolioMargin } from "@bloxwap/hyperliquid/api/exchange";
