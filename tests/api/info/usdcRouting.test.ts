import { usdcRouting } from "@bloxwap/hyperliquid/api/info";
...
runTest({
  ...
  codeTestFn: async (_t, client) => {
    ...
    schemaCoverage(responseSchema, data, ["#/properties/depositRoute/enum/0", "#/properties/withdrawalRoute/enum/0"]);
  },
});
