...
import { type GossipPriorityBidParameters, GossipPriorityBidRequest } from "@bloxwap/hyperliquid/api/exchange";
...
const paramsSchema = valibotToJsonSchema(v.omit(v.object(GossipPriorityBidRequest.entries.action.entries), ["type"]));
