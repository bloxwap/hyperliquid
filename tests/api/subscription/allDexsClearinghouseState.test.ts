...
const sourceFile = new URL("../../../src/api/subscription/_methods/allDexsClearinghouseState.ts", import.meta.url)
  .pathname;
...
runTest({
  ...
  mode: "api",
  fn: async (_t, client) => {
    const params: AllDexsClearinghouseStateParameters[] = [{ user: "0x563C175E6f11582f65D6d9E360A618699DEe14a9" }];
